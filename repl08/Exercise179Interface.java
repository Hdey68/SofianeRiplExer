...
public abstract class Exercise179Interface {
...
Result is ::: 5.0
    ...
    interface Fonctions extends Outputs {

        default void adding(double firstNumber, double secondNumber) {
            double result = firstNumber + secondNumber;
            System.out.println("Result is ::: " + result);
        }
        default void subtracting(double firstNumber, double secondNumber) {
            double result = firstNumber - secondNumber;
            System.out.println("Result is ::: " + result);
        }
        default void multiply(double firstNumber, double secondNumber) {
            double result = firstNumber * secondNumber;
            System.out.println("Result is ::: " + result);
        }
        default void dividing(double firstNumber, double secondNumber) {
            double result = firstNumber / secondNumber;
            System.out.println("Result is ::: " + result);
        }
    }
        static class Main implements Fonctions {
            @Override
